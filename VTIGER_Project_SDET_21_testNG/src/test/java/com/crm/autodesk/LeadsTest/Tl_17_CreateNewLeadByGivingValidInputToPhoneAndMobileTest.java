 ...
 *
 */
public class Tl_17_CreateNewLeadByGivingValidInputToPhoneAndMobileTest extends BaseClass
{
	...
	public void createLeadByGivingValidInputToPhoneAndMobile() throws Throwable
	{
		...
		int Phone = excelLib.getIntDataFromExcelFile("Sheet3", 4, 4);
		int Mobile = excelLib.getIntDataFromExcelFile("Sheet3", 4, 5);
